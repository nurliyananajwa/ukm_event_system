...
$userName = $identity?->name ?? 'Organizer';
...
$activeEvents = ($currentController === 'events' && $currentAction === 'index') ? 'active' : '';
$activeAdd    = ($currentController === 'events' && $currentAction === 'add') ? 'active' : '';
?>
<!DOCTYPE html>
<html>
<head>
    ...
    <title><?= h($this->fetch('title') ?: 'Organizer Panel') ?></title>
    ...
    <aside class="sidebar">
        ...
        <nav class="nav">
            ...
            <?= $this->Html->link(
                ...
                ['escape'=>false, 'class'=>$activeEvents]
            ) ?>
        ...
        <nav class="nav">
            <?= $this->Html->link(
                '<div class="ico">
                    <svg class="svg" viewBox="0 0 24 24" fill="none">
                        <path d="M10 7V5a2 2 0 0 1 2-2h7a2 2 0 0 1 2 2v14a2 2 0 0 1-2 2h-7a2 2 0 0 1-2-2v-2" stroke="#ffffff" stroke-width="2" stroke-linecap="round"/>
                        <path d="M15 12H3m0 0 3-3M3 12l3 3" stroke="#ffffff" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
                    </svg>
                </div>Logout',
    ...
    <main class="main">
        <div class="topbar">
            <form class="search" method="get"
                  action="<?= $this->Url->build(['prefix'=>'Organizer','controller'=>'Events','action'=>'index']) ?>">
                <svg class="svg" viewBox="0 0 24 24" fill="none">
