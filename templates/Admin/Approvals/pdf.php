...
$this->assign('title', 'Event Approval Copy');

// Since EventsTable hasOne('Approvals', propertyName => 'approval'),
// paling selamat ambil dari $event->approval
...
$adminComments = (string)($approval->comments ?? '');
...
<div class="title">Event Application (Admin Copy)</div>
<p class="desc">
  This document serves as the administrative reference copy for the event application and approval decision.
</p>
...
<?php else: ?>
  <table class="table">
    ...
    <?php foreach ($docs as $d): ?>
      <tr>
        <td><?= h((string)($d->document_type?->type_name ?? $d->doc_type?->type_name ?? '-')) ?></td>
...
<div class="section-title">Admin Decision</div>
<table class="table kv">
  <tr>
    <td class="key">Status</td>
    <td class="val"><span class="<?= h($badgeCls) ?>"><?= h($status) ?></span></td>
  </tr>
  <tr class="avoid-break">
    <td class="key">Comments</td>
    <td class="val prewrap"><?= h($adminComments !== '' ? $adminComments : 'No comments.') ?></td>
  </tr>
</table>
