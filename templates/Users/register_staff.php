<?php
$this->assign('title', 'Create Admin');
$this->setLayout('auth');
?>
...
<div class="auth-card">
    ...
    <div class="auth-left">
        <div class="auth-left-content">
            ...
            <h2>Admin</h2>
            <p>
                Create internal accounts for reviewing approvals
    ...
    <div class="auth-right">
        ...
        <?= $this->Form->button('Create Account', ['class' => 'btn-primary']) ?>
        <?= $this->Form->end() ?>

        <p class="auth-footer">
            <?= $this->Html->link('Back to Sign In', ['action' => 'login']) ?>
        </p>
    </div>
